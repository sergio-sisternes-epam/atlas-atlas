...
- [Retrieval can open a gated update window; in-place rewrite is not settled](reconsolidation-gated-update.md)
- [Prediction error may choose update versus a second trace](prediction-error-update-or-differentiate.md) (protostar)
- [Forgetting is usually failed expression, not guaranteed deletion](forgetting-is-expression-failure.md)
- [Permanence of a page is not evidence it is current or true](do-not-equate-immutability-with-correct-memory.md)
