...
status: designed
description: "Mini-genesis design plan moved into Atlas skill memory from artifacts/autogenesis-plans/. Awaits approval before implement."
plan_path: experiences/2026-08-23-design-plan-atlas-migrate-cli-improve-v1.md
relates_to:
...
Design plan for work `atlas-migrate-cli-improve-v1` was authored under `artifacts/autogenesis-plans/` and is now the durable copy inside the Atlas skill process memory. External path remains as provenance only.

## What happened

Plan content (authoritative in this Atlas page):
...
Plan lives at `experiences/2026-08-23-design-plan-atlas-migrate-cli-improve-v1.md` under the atlas skill store. Work hub updated to point here. Staging cleared. Compile must be green.

## Follow-ups

Explicit user approval required before implement path.
