...
- [recipes/](recipes/) — reusable how-to
- [decisions/](decisions/) — pinned design decisions
- [work/](work/) — task hubs (`work_id` clusters)
- [autogenesis/](autogenesis/) — Autogenesis-authored pages (discussion fabric under `discuss/`)
- [atlas-project/](atlas-project/) — product vision, correct comparison, terminated wrong path
